...
import com.zxc.common.utils.DateUtil;
import com.zxc.common.utils.IdWorker;
import com.zxc.attendance.dao.AttendanceConfigDao;
import com.zxc.attendance.dao.AttendanceDao;
import com.zxc.attendance.dao.UserCDao;
import com.zxc.model.atte.entity.Attendance;
import com.zxc.model.atte.entity.AttendanceConfig;
import com.zxc.model.atte.vo.AtteUploadVo;
    ...
    public void importAttendanceExcel(MultipartFile file, String companyId) throws Exception {
        ...
        for (AtteUploadVo atteUploadVo : atteUploadVos) {
            ...
            if (holidays.contains(atteUploadVo.getAtteDate())){
                attendance.setAdtStatu(23); //23为休息
