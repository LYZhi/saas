package com.zxc.socialSecurity.controller;
...
import com.zxc.model.social_security.*;
import com.zxc.socialSecurity.service.ArchiveService;
import com.zxc.socialSecurity.service.CompanySettingsService;
import com.zxc.socialSecurity.service.PaymentItemService;
import com.zxc.socialSecurity.service.UserSocialService;
...
public class SocialSecurityController extends BaseController implements SocialSecurityInter {
    ...
    public Result findById(@PathVariable String id){
        Map map = new HashMap();
        //1.根据用户id查询用户数据
        Object user = systemInter.findById(id).getData();
        map.put("user",user);
        //2.根据用户id查询社保数据
