...
import com.zxc.common.shiro.session.CustomSessionManager;
import com.zxc.system.realm.UserRealm;
...
public class ShiroConfiguration {
    ...
    //2.创建安全管理器
    @Bean
    public SecurityManager getSecurityManager(@Qualifier(value = "myrealm") IhrmRealm realm) {
